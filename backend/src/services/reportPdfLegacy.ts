/**
 * Vecchio design del PDF del singolo report, congelato qui per poterci tornare.
 * Si attiva impostando REPORT_PDF_LAYOUT=legacy (vedi reportPdf.ts).
 * Il file e' volutamente autosufficiente: modifiche al nuovo layout non devono toccarlo.
 */
import path from "node:path";
import pdfmake from "pdfmake";

import type { ReportPrintData } from "./reportPdf";
...
export const createLegacyReportPdfBuffer = async (report: ReportPrintData, logoDataUrl: string | null) => {
